...
namespace ZeroEngine {
    ...
    public:
        virtual bool on_trigger(const GamepadTriggerName& trigger_name, const float pressure) = 0;
        virtual bool on_button_up(const GamepadButtonName& button_name) = 0;
        virtual bool on_button_down(const GamepadButtonName& button_name, const float pressure) = 0;
        virtual bool on_directional_pad(const GamepadDirectionalName& directional_name) = 0;
        virtual bool on_joystick_move(const GamepadJoystickName& joystick_name, const float x, const float y) = 0;
