...
namespace ZeroEngine {
    ...
    Logger::Logger() {
        _debug_tag = new std::string("DEBUG");
        _todo_tag = new std::string("TODO");
        _unimplemented_tag = new std::string("UNIMPLEMENTED");
    ...
    Logger::~Logger() {
        ...
        delete _unimplemented_tag;
        _unimplemented_tag = nullptr;
    }
